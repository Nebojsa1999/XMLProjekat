...
export class RegisterCompanyComponent implements OnInit {
  ...
  register(){
    if(this.form.valid){
      let dto: NewCompanyDto = {name: this.name.value, address: this.address.value, email: this.email.value, phone: this.phone.value, areaOfWork: this.areaOfWork.value, description: this.description.value, workCulture: this.workCulture.value,status: "Pending",ownerId:this.id}
