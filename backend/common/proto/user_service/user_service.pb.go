...
func (User_Gender) EnumDescriptor() ([]byte, []int) {
	return file_user_service_user_service_proto_rawDescGZIP(), []int{14, 0}
}
...
var file_user_service_user_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0xee,
	...
	0x1c, 0x0a, 0x09, 0x69, 0x73, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x0a,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x29, 0x0a,
	0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e,
	...
	0x4f, 0x66, 0x42, 0x69, 0x72, 0x74, 0x68, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	...
	,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0xe7, 0x04, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
...
var file_user_service_user_service_proto_goTypes = []interface{}{
	...
	(*Credentials)(nil),                    // 16: user.Credentials
	(*timestamppb.Timestamp)(nil),          // 17: google.protobuf.Timestamp
}
var file_user_service_user_service_proto_depIdxs = []int32{
	15, // 0: user.GetResponse.user:type_name -> user.User
	15, // 1: user.GetAllResponse.users:type_name -> user.User
	15, // 2: user.RegisterRequest.user:type_name -> user.User
	16, // 3: user.LoginRequest.credentials:type_name -> user.Credentials
	15, // 4: user.SearchPublicUsersResponse.users:type_name -> user.User
	0,  // 5: user.User.gender:type_name -> user.User.Gender
	17, // 6: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	1,  // 7: user.UserService.Get:input_type -> user.GetRequest
	3,  // 8: user.UserService.GetAll:input_type -> user.GetAllRequest
	5,  // 9: user.UserService.RegisterANewUser:input_type -> user.RegisterRequest
	7,  // 10: user.UserService.Login:input_type -> user.LoginRequest
	9,  // 11: user.UserService.IsUserPrivate:input_type -> user.IsPrivateRequest
	11, // 12: user.UserService.GetIdsOfAllPublicUsers:input_type -> user.GetIdsOfAllPublicUsersRequest
	13, // 13: user.UserService.SearchPublicUsers:input_type -> user.SearchPublicUsersRequest
	2,  // 14: user.UserService.Get:output_type -> user.GetResponse
	4,  // 15: user.UserService.GetAll:output_type -> user.GetAllResponse
	6,  // 16: user.UserService.RegisterANewUser:output_type -> user.RegisterResponse
	8,  // 17: user.UserService.Login:output_type -> user.LoginResponse
	10, // 18: user.UserService.IsUserPrivate:output_type -> user.IsPrivateResponse
	12, // 19: user.UserService.GetIdsOfAllPublicUsers:output_type -> user.GetIdsOfAllPublicUsersResponse
	14, // 20: user.UserService.SearchPublicUsers:output_type -> user.SearchPublicUsersResponse
